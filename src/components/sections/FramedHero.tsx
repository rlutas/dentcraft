      ...
      >
        <div
          className={cn(
            ...
            isScrolled
              ? 'bg-white/98 backdrop-blur-xl border-[#e8e0d5] pl-5 pr-3 py-2 md:pl-6 md:pr-3 md:py-1 shadow-[0_10px_40px_-8px_rgba(42,33,24,0.25)]'
              : 'bg-white/95 backdrop-blur-md border-white/60 pl-5 pr-3 py-2.5 md:pl-8 md:pr-4 md:py-1.5 shadow-[0_10px_40px_-10px_rgba(42,33,24,0.35)]'
          )}
        >
          {/* Logo */}
          ...
          <div className="flex items-center gap-2 shrink-0 justify-self-end">
            ...
            <button
              type="button"
              onClick={() => setBookingOpen(true)}
              className="group hidden sm:inline-flex items-center px-6 md:px-10 py-3 md:py-5 bg-[#2a2118] text-white rounded-full text-sm md:text-lg font-semibold hover:shadow-[0_10px_24px_-8px_rgba(42,33,24,0.4)] transition-shadow duration-300"
            >
              <span>{tHero('ctaPrimary')}</span>
              <span
                aria-hidden="true"
