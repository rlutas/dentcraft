...
## De ce avem nevoie de aceste materiale
...
- [ ] **Minim 3 video-uri** cu pacienti multumiti (ideal 5-6)
- [ ] Fiecare pacient trebuie sa spuna pe scurt experienta lor

### Specificatii tehnice:

| Parametru | Valoare |
|-----------|---------|
| **Orientare** | **Vertical (9:16)** - prioritar; se accepta si landscape (16:9) |
| **Rezolutie** | Minim 1080x1920 (Full HD vertical) |
| **Format** | MP4 (H.264) |
| **Durata** | 30-60 secunde per video |
| **Audio** | Clar, fara zgomot de fundal (microfon lavaliera ideal) |
| **Lumina** | Buna, fata pacientului sa fie bine luminata |

### Ce sa contina fiecare video:

1. Numele pacientului (prenume + initiala)
2. Ce tratament a facut (ex: implant, fatete, albire)
3. Cum a fost experienta la clinica
4. Rezultatul - cat de multumit este

### Informatii necesare per video:

```
- Numele pacientului (pentru afisare pe site)
- Tipul tratamentului efectuat
- Rating (1-5 stele)
- Consimtamant semnat pentru publicare online
```

### Varianta alternativa:

Daca nu exista video-uri proprii, se pot folosi si link-uri YouTube/YouTube Shorts. Site-ul suporta embed de la YouTube si Vimeo.
...
- [ ] **Minim 3-4 seturi de calitate** pentru lansare (ideal 8-10)
- [ ] Fiecare set = 1 poza BEFORE + 1 poza AFTER
...
|-----------|---------|
| **Format** | JPG sau PNG |
| **Rezolutie minima** | 800 x 600 px (ideal 1200 x 900 px) |
| **Aspect ratio** | 4:3 (landscape) - recomandat |
| **Dimensiune max fisier** | 400 KB per imagine (se optimizeaza automat pe site) |

### Reguli IMPORTANTE pentru fotografiere:

1. **Acelasi unghi** - poza before si after trebuie facute din exact acelasi unghi
2. **Aceeasi lumina** - iluminare consistenta in ambele poze
3. **Acelasi fundal** - fundal neutru, identic
4. **Aceeasi distanta** - camera la aceeasi distanta de subiect
5. **Focus pe zona tratata** - dintii sa fie clar vizibili

### Informatii necesare per caz:

```
1. Poza BEFORE
2. Poza AFTER
3. Titlu caz (ex: "Fatete ceramice - zambet complet")
4. Tip tratament / Serviciul asociat
5. Durata tratament (ex: "2 saptamani", "3 luni")
6. Descriere scurta a cazului (2-3 propozitii)
7. Doctorul care a efectuat tratamentul
8. Consimtamant pacient pentru publicare (OBLIGATORIU)
```

### Tipuri de cazuri recomandate (minim 1 din fiecare):

- [ ] Fatete / Estetica dentara
- [ ] Implant dentar
- [ ] Albire profesionala
- [ ] Protetica (coroane, punti)
...
### Fotografii existente (12 buc):

Avem poze de interior in `/public/images/clinic/`. Daca acestea sunt actuale si reprezentative, le pastram. Daca doriti sa le inlocuiti:

### Ce am mai avea nevoie (optional, pentru imbunatatire):

- [ ] **Fatada clinicii** (exterior) - 1-2 poze
- [ ] **Receptie / Sala de asteptare** - actualizate daca s-au facut schimbari
- [ ] **Cabinet in timpul tratamentului** (cu pacient, din spate, anonim) - 1-2 poze
- [ ] **Echipamente moderne** (CBCT, microscop, scanner digital) - 1-2 poze close-up
...
|-----------|---------|
| **Format** | JPG |
| **Rezolutie minima** | 1920 x 1080 px (Full HD) |
| **Stil** | Lumina naturala sau bine iluminat artificial |
| **Fotograf** | Profesional recomandat |

### Ce sa surprinda pozele:

- Spatii curate, ordonate, fara obiecte personale vizibile
- Echipamente moderne si tehnologie avansata
- Atmosfera calda, primitoare (nu clinica rece)
- Detalii de lux/premium (materiale, finisaje, plante decorative)
...
| Persoana | Fisier | Status |
|----------|--------|--------|
| Dr. Petric Razvan-Tudor | `dr-petric-razvan-tudor.jpg` + link extern | OK |
| Dr. Ghirasim Denisa Stefania | `dr-ghirasim-denisa-stefania.png` | OK |
| Dr. Tincu Giovana | `dr-tincu-giovana.png` | OK |
| Gherman Camelia | `asistent-gherman-camelia.png` | OK |
| Daraban Karla | `asistent-daraban-carla.png` | OK |
| Danci Ionela Mikaela | `asistent-danci-ionela-mikaela.png` | OK |

### Ce am mai avea nevoie (optional):

- [ ] **Poza de grup** a intregii echipe (pentru Hero-ul principal)
- [ ] **Poze actualizate** daca sunt membri noi sau daca cineva a plecat
- [ ] **Poze in actiune** (doctor lucrand, echipa colaborand) - pentru pagini individuale

### Specificatii tehnice:

| Parametru | Valoare |
|-----------|---------|
| **Format** | JPG sau PNG (fundal transparent ideal) |
| **Rezolutie portrete** | Minim 600 x 800 px (aspect ratio 3:4) |
| **Rezolutie poza grup** | Minim 1200 x 800 px |
| **Fundal** | Neutru (gri deschis, alb) sau in clinica |
| **Stil** | Profesional, zambitor, in halat medical |
| **Cadraj portrete** | De la talie in sus, centrat pe fata |
...
- [ ] **O fotografie reprezentativa** a echipei sau a doctorului principal

### Variante acceptate:

1. **Poza de grup** - toata echipa zambind, in clinica
2. **Dr. Petric** - portret profesional, zambitor, in clinica
3. **Dr. Petric cu pacient** - moment de consultatie (pacient din spate/anonim)
...
|-----------|---------|
| **Format** | JPG |
| **Rezolutie** | Minim 1200 x 800 px (ideal 1920 x 1280 px) |
| **Calitate** | Profesionala, fotograf recomandat |
| **Lumina** | Calda, naturala |
| **Max fisier** | 500 KB (se optimizeaza automat) |
...
## CUM SA TRIMITETI MATERIALELE

1. **Google Drive** - creati un folder partajat si trimiteti link-ul
2. **WeTransfer** - pentru fisiere mari (video)
3. **Email** - doar pentru fisiere mici (sub 25 MB)
...
DENTCRAFT Content/
  ...
  before-after/
    caz-1-fatete/
      before.jpg
      after.jpg
      info.txt  (titlu, tratament, durata, descriere)
    caz-2-implant/
      before.jpg
      after.jpg
      info.txt
  ...
  consimtaminte/
    pacient-1-consimtamant.pdf
    pacient-2-consimtamant.pdf
```
...
- **Toate video-urile si pozele before/after necesita consimtamant scris** al pacientului pentru publicare online
- Pozele before/after pot folosi doar prenumele + initiala numelui de familie
- Video-urile vor fi afisate public pe site si potentialele embed-uri pe YouTube

---

*Daca aveti intrebari despre specificatii sau aveti nevoie de ajutor cu filmarea/fotografierea, nu ezitati sa ne contactati.*
